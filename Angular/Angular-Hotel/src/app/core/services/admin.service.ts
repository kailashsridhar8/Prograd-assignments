...
export class AdminService {
  ...
  onAddRoom(roomtype: string,price: number,capacity: number,image: string,ratings:string){
   
    return this.http.post("http://127.0.0.1:8000/admin/addRoom",{roomtype: roomtype,price: price,capacity: capacity,image: image,ratings:ratings});
  }
